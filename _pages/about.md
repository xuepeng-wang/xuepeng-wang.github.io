...
Research Interests
======
Unlike Monte-Carlo[^1], my research interests diverge. Specifically, I am interested in
- **Non-Fermi Liquids & Strange Metals**: including their spectral properties, transport and collective excitations.
- **Moiré materials**: unconventional superconductivity, exotic composite excitations, correlated topological phases, intertwined orders and quantum phase transitions.
- **Quantum Many-Body Methods**: determinant quantum Monte-Carlo, large-N field theory, and Green's function compression techniques such as discrete Lehmann representations.
...
[^1]: In most case assuming CLT holds.
